...
public class SniperItem extends HaloGunBase {
	...
	public SniperItem() {
		super(new Item.Settings().group(MCHaloMod.HALOTAB).maxCount(1).maxDamage(config.sniper_max_ammo + 1));
	}
	...
	public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
		...
		tooltip.add(new TranslatableText(
				"Damage: " + (j > 0 ? (config.sniper_bullet_damage + (j * 1.5F + 0.5F)) : config.sniper_bullet_damage))
