...
public class NeedleRender extends GeoEntityRenderer<NeedleEntity> {
	...
	public NeedleRender(EntityRendererProvider.Context renderManagerIn) {
	...
	@Override
	public void preRender(PoseStack poseStack, NeedleEntity animatable, BakedGeoModel model,
